...
describe('SettingsStore', () => {
	...
	describe('loadSettings', () => {
		...
		it('should merge saved data with defaults', async () => {
			...
			const loadedSettings = settingsStore.getSettings();
			expect(loadedSettings.githubToken).toBe('ghp_test_token_123456789012345678901234567890');
	...
	describe('saveSettings', () => {
		it('should save settings to app data', async () => {
			...
			await settingsStore.set('githubToken', 'ghp_test_token_123456789012345678901234567890');
		...
		it('should handle save errors', async () => {
			...
			await expect(
				settingsStore.set('githubToken', 'ghp_test_token_123456789012345678901234567890')
			).rejects.toThrow();
		});
	});
	...
	describe('update', () => {
		it('should update multiple settings at once', async () => {
			...
			expect(settingsStore.get('githubToken')).toBe('ghp_test_token_123456789012345678901234567890');
			expect(settingsStore.get('autoSyncEnabled')).toBe(true);
